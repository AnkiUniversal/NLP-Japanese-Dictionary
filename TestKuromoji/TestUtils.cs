...
namespace NLPJDictTest
{
    public static class TestUtils
    {
        ...
        public static string AbsoluteIpadicResourcePath = @"./KuromojiIpadic/Resource/";        
        public static string DictResourcedPath = @"./KuromojiIpadic/Resource";        

        public static FileStream CreateNewFile(string fileName)
        {                        
